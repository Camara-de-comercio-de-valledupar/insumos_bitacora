    ...
    <div style="min-height: 100vh" class="container-fluid d-flex flex-column justify-content-center align-items-center">
        <div class="d-flex flex-row justify-content-between align-items-center w-100 my-5">
            ...
            <div class="flex flex-column justify-content-center align-items-start">
                <h1 class="text-end">{{ $bitacora->anio }} -
                    {{ \Carbon\Carbon::create($bitacora->anio, $bitacora->mes)->format('F', 'ES') }}</h1>
        ...
        <form class="my-auto mx-auto" method="POST"
            action="{{ route('bitacora.update', [
                'bitacora' => $bitacora,
                ...
                <div class="d-flex flex-row flex-wrap justify-content-stretch align-items-start">
                    ...
                    <div class="col-12 col-md-6 p-1">
                        <div class="form-group">
                            ...
                            <input value="{{ old('usuario') ?? $detalleBitacora->usuario }}" type="text"
                    ...
                    <div class="col-12 col-md-6 p-1">
                        <div class="form-group">
                            ...
                            <input value="{{ old('responsable') ?? $detalleBitacora->responsable }}" type="text"
                    ...
                    <div class="col-12 col-md-6 p-1">
                        <div class="form-group">
                            ...
                            <input value="{{ old('dia') ?? $detalleBitacora->dia }}" type="date"
                    ...
                    <div class="col-12 col-md-2 p-1">
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ old('hora_salida') ?? $detalleBitacora->hora_salida }}" type="time"
                    ...
                    <div class="col-12 col-md-2 p-1">
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ old('km_salida') ?? $detalleBitacora->km_salida }}" min="0"
                    ...
                    <div class="col-12 col-md-2 p-1">
                        ...
                        <div class="form-group">
                            ...
                            <select value="{{ old('tanque_salida') ?? $detalleBitacora->tanque_salida }}"
                                name="tanque_salida" id="tanque_salida"
                                class="form-select {{ $errors->has('tanque_salida') ? 'is-invalid' : '' }}">
                                <option value="" {{ old('tanque_salida') == '' ? 'selected' : '' }} disabled>
                                    Seleccione una opción</option>
                                <option value="Full"
                                    {{ old('tanque_salida') ?? $detalleBitacora->tanque_salida == 'Full' ? 'selected' : '' }}>
                                    Lleno
                                </option>
                                <option value="1/2"
                                    {{ old('tanque_salida') ?? $detalleBitacora->tanque_salida == '1/2' ? 'selected' : '' }}>
                                    1/2
                                </option>
                                <option value="1/4"
                                    {{ old('tanque_salida') ?? $detalleBitacora->tanque_salida == '1/4' ? 'selected' : '' }}>
                                    1/4
                                </option>
                                <option value="Vacio"
                                    {{ old('tanque_salida') ?? $detalleBitacora->tanque_salida == 'Vacio' ? 'selected' : '' }}>
                                    Vacio
                                </option>
                                >
                            </select>
                    ...
                    <div class="col-12 row-2 col-md-6 p-1">
                        <div class="form-group">
                            ...
                            <textarea rows="4" type="text" class="form-control {{ $errors->has('observaciones') ? 'is-invalid' : '' }}"
                                name="observaciones" id="observaciones">{{ old('observaciones') ?? $detalleBitacora->observaciones }}</textarea>
                            @error('observaciones')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-12 col-md-6 d-flex flex-row flex-wrap justify-content-stretch align-items-start">
                        ...
                        <div class="col-12 col-md-4 p-1">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ old('hora_llegada') ?? $detalleBitacora->hora_llegada }}"
                                    type="time"
                        ...
                        <div class="col-12 col-md-4 p-1">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ old('km_llegada') ?? $detalleBitacora->km_llegada }}" type="number"
                        ...
                        <div class="col-12 col-md-4 p-1">
                            ...
                            <div class="form-group">
                                ...
                                <select value="{{ old('tanque_llegada') ?? $detalleBitacora->tanque_llegada }}"
                                    name="tanque_llegada" id="tanque_llegada"
                                    ...
                                    <option value="Full"
                                        {{ old('tanque_llegada') ?? $detalleBitacora->tanque_llegada == 'Full' ? 'selected' : '' }}>
                                        Lleno</option>
                                    <option value="1/2"
                                        {{ old('tanque_llegada') ?? $detalleBitacora->tanque_llegada == '1/2' ? 'selected' : '' }}>
                                        1/2
                                    </option>
                                    <option value="1/4"
                                        {{ old('tanque_llegada') ?? $detalleBitacora->tanque_llegada == '1/4' ? 'selected' : '' }}>
                                        1/4
                                    </option>
                                    <option value="Vacio"
                                        {{ old('tanque_llegada') ?? $detalleBitacora->tanque_llegada == 'Vacio' ? 'selected' : '' }}>
                                        Vacio</option>
                                </select>
                        ...
                        <div class="col-12 col-md-6 p-1">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    value="{{ old('gasolina_galones_compradas') ?? $detalleBitacora->gasolina_galones_compradas }}"
                                    type="number"
                        ...
                        <div class="col-12 col-md-6 p-1">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ old('gasolina_precio') ?? $detalleBitacora->gasolina_precio }}"
