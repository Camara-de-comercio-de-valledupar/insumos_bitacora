...
class ActualizarBitacoraRequest extends FormRequest
{
    ...
    public function actualizarBitacora(Bitacora $bitacora, DetalleBitacora $detalle): Bitacora
    {
        $detalle = $this->crearDetalleBitacora($detalle);
        $bitacora->detalles()->save($detalle);
        return $bitacora;
    }

    private function crearDetalleBitacora(DetalleBitacora $detalle): DetalleBitacora
    {
